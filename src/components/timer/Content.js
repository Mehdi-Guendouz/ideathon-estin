        ...
        <div className='first-div' id='#home'>
            <div className='second-div'>
                ...
                <div className='text-div w-full flex items-center justify-center flex-col gap-1 md:gap-0'>                         
                    ...
                    <p className='lg:text-[65px] sm:text-[55px] text-[24px]'>and <span id='technicate'>technicate</span> <span className='relative'><img src={vector} alt="vector" className='absolute w-[100px] h-[10px] sm:w-fit sm:h-fit right-0' /> together</span></p>
