		...
		<div className='pt-5 md:mt-8' >
			<div className='container relative mx-auto md:pt-[122.44px] md:pb-[100.3px]'>
			    ...
			    <div className='flex justify-center flex-wrap relative md:mt-20 mt-[58px] md:items-center'>
                    <p className='md:w-[552px] md:text-[36px] w-[396px]  font-[350] md:leading-[40.68px]' data-aos="fade-up" data-aos-duration='1000' data-aos-delay='100'>IdeaTech is an ideathon on its second-year edition in the higher national school of computer and digital sciences and technologies (ESTIN Amizour), organized by the scientific club ByteCraft. </p>
                ...
                <div className='flex justify-center flex-wrap-reverse relative md:mt-[59.5px] mt-[47px] md:items-center'>
                    <div className='image relative mt-8 xl:mt-0' data-aos="fade-right" data-aos-duration='1000' data-aos-delay='600'>
                    ...
                    <p className='md:text-[36px] md:ml-[23px] md:w-[617px] md:leading-[40.68px] w-[396px] text-[22px] font-[350] ' data-aos="fade-up" data-aos-duration='1000' data-aos-delay='100'>We welcome all participants from all around the country to this competition, to come up with and develop ideas solutionary to a given theme of problematics, where they realize a prototype without the coding part,  in teams of 15 and only in 48 hours, provided with copious (abundance)resources, mentors, qualified speakers, accommodation to empower and guide you through this journey.</p>
                </div>
