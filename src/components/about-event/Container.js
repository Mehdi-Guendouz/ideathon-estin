		...
		<>
			<div className='container relative mx-auto md:pt-[122.44px] md:pb-[100.3px]'>
			    ...
			    <div className='flex justify-center flex-wrap relative md:mt-20 mt-[58px] md:items-center'>
                    <p className='md:w-[552px] md:text-[36px] w-[396px] md:text-[22px] font-[350] md:leading-[40.68px]'>IdeaTech is an ideathon on its second-year edition in the higher national school of computer and digital sciences and technologies (ESTIN Amizour), organized by the scientific club ByteCraft. </p>
