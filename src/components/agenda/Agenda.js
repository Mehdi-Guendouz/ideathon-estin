...
function Agenda() {
    ...
    return (
        <section id='agenda' className='font-[whyte]'>
            ...
            <div className='grid grid-cols-[1fr_5fr] grid-rows-2 gap-x-[8%] mx-40 py-[10rem]'>
                <div id='day-1' 
                className={`relative w-max h-fit mt-auto mb-40 px-[7%] pb-1 font-bold text-5xl cursor-pointer 
