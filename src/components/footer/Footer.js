...
const Footer = () => {
  ...
  return (
    <footer style={{ zIndex: 1000 }} className='w-full flex items-center justify-center py-20 md:py-10 mt-4 sm:mt-0'>
      <div className=" flex items-center justify-center w-full flex-col gap-[10px]">
        <div className="parent flex items-center justify-around w-full">
          ...
          <div className='flex items-center justify-center gap-[10px] md:gap-[2rem] mr-1 md:mr-5'>
            ...
            <a href='https://www.linkedin.com/company/bytecraft-club' target="_blank" rel="noopener noreferrer" ><img className="in cursor-pointer sm:w-[30px] sm:h-[30px] w-[20px] h-[20px]" src={require('../../img/in.png')} alt="line" /></a>
