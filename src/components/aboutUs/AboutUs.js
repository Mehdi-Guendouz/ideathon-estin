        ...
        <div className='w-full grid grid-cols-12 gap-4 '>
          {/* .............................PARAGRAPH CONTENT.......................... */}
            <div className='w-full h-full col-span-12  md:col-span-6 flex items-center justify-center'>
              <p className='text-start text-xl lg:text-2xl xl:text-3xl text-bold mx-4 md:mr-0 md:ml-[20%] mt-0 md:mt-[10%]  ' data-aos="fade-up" data-aos-duration='1000' data-aos-delay='100'>
